...
CREATE OR REPLACE TASK HOL_DB.HARMONIZED.ORDERS_UPDATE_TASK
WAREHOUSE = HOL_WH
WHEN
...
CREATE OR REPLACE TASK HOL_DB.HARMONIZED.DAILY_CITY_METRICS_UPDATE_TASK
WAREHOUSE = HOL_WH
AFTER HOL_DB.HARMONIZED.ORDERS_UPDATE_TASK
WHEN
